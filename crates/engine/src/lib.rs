...
fn cuda_cpu_resolved_filter_mask(
    rows: &[ResolvedMvccRow],
    runtime: &CudaDriverRuntime,
    filter: &MvccReadFilter,
) -> Result<Vec<bool>, ()> {
...
fn resolve_cuda_native_follow_value_chain_from_seed(
    all_version_rows: &[ResolvedMvccRow],
    seed: &TupleVersion,
    visibility: StorageVisibility,
    plan: MvccValueChainPlan,
...
fn resolve_cuda_native_follow_value_chain_branches_rows(
    all_version_rows: &[ResolvedMvccRow],
    keys: &[String],
    visibility: StorageVisibility,
...
fn resolve_cuda_native_follow_value_chain_labeled_branches_rows(
    all_version_rows: &[ResolvedMvccRow],
    keys: &[String],
    visibility: StorageVisibility,
...
fn execute_cuda_native_follow_value_chain_branches_query(
    query: &MvccReadQuery,
    keys: &[String],
    plans: &[MvccValueChainPlan],
    fan_in: MvccValueChainBranchFanIn,
...
fn execute_cuda_native_follow_value_chain_labeled_branches_query(
    query: &MvccReadQuery,
    keys: &[String],
    branches: &[MvccLabeledValueChainBranch],
    fan_in: MvccValueChainBranchFanIn,
...
fn first_cuda_slice_filter_gap_detail(filter: &MvccReadFilter) -> Option<FirstCudaFilterGap> {
    match filter {
        ...
        MvccReadFilter::SourceKeyPrefix(_)
        | MvccReadFilter::SourceValueEquals(_)
        | MvccReadFilter::BranchLabelEquals(_) => None,
        MvccReadFilter::All(filters) | MvccReadFilter::Any(filters) => {
...
#[cfg_attr(not(test), allow(dead_code))]
fn cuda_filter_contains_cpu_resolved_predicate(filter: &MvccReadFilter) -> bool {
    match filter {
        MvccReadFilter::SourceKeyPrefix(_)
        | MvccReadFilter::SourceValueEquals(_)
...
fn mvcc_provenance_segments_occurrence_start(
    segments: &[String],
    expected: &[String],
    occurrence: MvccProvenanceOccurrence,
) -> Option<usize> {
...
fn resolved_mvcc_row_provenance_bundle_occurrence_offset(
    row: &ResolvedMvccRow,
    bundle: MvccProvenanceFrameBundle,
    summary: MvccProvenanceSummary,
    expected: &[String],
...
fn resolved_mvcc_row_provenance_bundle_occurrence_distance(
    row: &ResolvedMvccRow,
    bundle: MvccProvenanceFrameBundle,
    summary: MvccProvenanceSummary,
...
fn mvcc_provenance_segments_have_prefix(segments: &[String], expected: &[String]) -> bool {
    !expected.is_empty()
        && expected.len() <= segments.len()
        && segments[..expected.len()] == *expected
}

fn mvcc_provenance_segments_have_slice_at(
    segments: &[String],
    start: usize,
    expected: &[String],
) -> bool {
...
fn mvcc_provenance_segments_first_subpath_start(
    segments: &[String],
    expected: &[String],
) -> Option<usize> {
    if expected.is_empty() || expected.len() > segments.len() {
...
fn mvcc_provenance_segments_last_subpath_start(
    segments: &[String],
    expected: &[String],
) -> Option<usize> {
    if expected.is_empty() || expected.len() > segments.len() {
...
fn mvcc_provenance_segments_start_within(
...
fn mvcc_provenance_segments_nth_subpath_start_within(
    segments: &[String],
    expected: &[String],
    occurrence_index: usize,
    start_min: usize,
...
fn mvcc_provenance_segments_occurrence_distance(
    segments: &[String],
    expected: &[String],
    left_occurrence_index: usize,
    right_occurrence_index: usize,
...
fn mvcc_provenance_segments_first_occurrence_distance(
    segments: &[String],
    expected: &[String],
) -> Option<usize> {
...
fn mvcc_provenance_segments_first_occurrence_distance_within(
    segments: &[String],
    expected: &[String],
    min_distance: usize,
    max_distance: usize,
...
fn mvcc_provenance_segments_last_occurrence_distance(
    segments: &[String],
    expected: &[String],
) -> Option<usize> {
...
fn mvcc_provenance_segments_last_occurrence_distance_within(
    segments: &[String],
    expected: &[String],
    min_distance: usize,
    max_distance: usize,
...
fn mvcc_provenance_segments_first_occurrence_to_occurrence_distance(
    segments: &[String],
    expected: &[String],
    occurrence_index: usize,
) -> Option<usize> {
...
fn mvcc_provenance_segments_first_occurrence_to_occurrence_distance_within(
    segments: &[String],
    expected: &[String],
    occurrence_index: usize,
    min_distance: usize,
...
fn mvcc_provenance_segments_first_occurrence_to_occurrence_at(
    segments: &[String],
    expected: &[String],
    occurrence_index: usize,
    first_start: usize,
...
fn mvcc_provenance_segments_first_occurrence_to_occurrence_within(
    segments: &[String],
    expected: &[String],
    occurrence_index: usize,
...
fn mvcc_provenance_segments_occurrence_to_last_distance(
    segments: &[String],
    expected: &[String],
    occurrence_index: usize,
) -> Option<usize> {
...
fn mvcc_provenance_segments_occurrence_to_last_distance_within(
    segments: &[String],
    expected: &[String],
    occurrence_index: usize,
    min_distance: usize,
...
fn mvcc_provenance_segments_occurrence_to_last_at(
    segments: &[String],
    expected: &[String],
    occurrence_index: usize,
    occurrence_start: usize,
...
fn mvcc_provenance_segments_occurrence_to_last_within(
    segments: &[String],
    expected: &[String],
    occurrence_index: usize,
    occurrence_start_range: std::ops::RangeInclusive<usize>,
...
fn mvcc_provenance_segments_occurrence_pair_at(
    segments: &[String],
    expected: &[String],
    left_occurrence_index: usize,
    left_start: usize,
...
fn mvcc_provenance_segments_occurrence_pair_within(
    segments: &[String],
    expected: &[String],
    left_occurrence_index: usize,
...
fn mvcc_provenance_segments_mixed_occurrence_distance(
    segments: &[String],
    left_expected: &[String],
    left_occurrence_index: usize,
    right_expected: &[String],
...
fn mvcc_provenance_segments_occurrence_distance_within(
    segments: &[String],
    expected: &[String],
    left_occurrence_index: usize,
    right_occurrence_index: usize,
...
fn mvcc_provenance_segments_mixed_occurrence_distance_within(
    segments: &[String],
    left_expected: &[String],
    left_occurrence_index: usize,
    right_expected: &[String],
...
fn mvcc_provenance_segments_first_mixed_occurrence_distance(
    segments: &[String],
    left_expected: &[String],
    right_expected: &[String],
) -> Option<usize> {
...
fn mvcc_provenance_segments_first_mixed_occurrence_distance_within(
    segments: &[String],
    left_expected: &[String],
    right_expected: &[String],
    min_distance: usize,
...
fn mvcc_provenance_segments_last_mixed_occurrence_distance(
    segments: &[String],
    left_expected: &[String],
    right_expected: &[String],
) -> Option<usize> {
...
fn mvcc_provenance_segments_last_mixed_occurrence_distance_within(
    segments: &[String],
    left_expected: &[String],
    right_expected: &[String],
    min_distance: usize,
...
fn mvcc_provenance_segments_first_mixed_occurrence_to_occurrence_distance(
    segments: &[String],
    left_expected: &[String],
    right_expected: &[String],
    right_occurrence_index: usize,
...
fn mvcc_provenance_segments_first_mixed_occurrence_to_occurrence_distance_within(
    segments: &[String],
    left_expected: &[String],
    right_expected: &[String],
    right_occurrence_index: usize,
...
fn mvcc_provenance_segments_occurrence_to_last_mixed_distance(
    segments: &[String],
    left_expected: &[String],
    left_occurrence_index: usize,
    right_expected: &[String],
...
fn mvcc_provenance_segments_occurrence_to_last_mixed_distance_within(
    segments: &[String],
    left_expected: &[String],
    left_occurrence_index: usize,
    right_expected: &[String],
...
fn mvcc_provenance_segments_first_mixed_occurrence_to_occurrence_at(
    segments: &[String],
    left_expected: &[String],
    left_start: usize,
    right_expected: &[String],
...
fn mvcc_provenance_segments_first_mixed_occurrence_to_occurrence_within(
    segments: &[String],
    left_expected: &[String],
    left_start_range: std::ops::RangeInclusive<usize>,
    right_expected: &[String],
...
fn mvcc_provenance_segments_occurrence_to_last_mixed_at(
    segments: &[String],
    left_expected: &[String],
    left_occurrence_index: usize,
    left_start: usize,
...
fn mvcc_provenance_segments_occurrence_to_last_mixed_within(
    segments: &[String],
    left_expected: &[String],
    left_occurrence_index: usize,
    left_start_range: std::ops::RangeInclusive<usize>,
...
fn mvcc_provenance_segments_mixed_occurrence_at(
    segments: &[String],
    left_expected: &[String],
    left_occurrence_index: usize,
    left_start: usize,
...
fn mvcc_provenance_segments_mixed_occurrence_within(
    segments: &[String],
    left_expected: &[String],
    left_occurrence_index: usize,
...
fn sort_relational_keys(keyed_rows: &mut [(String, SqlValue)], descending: bool) {
