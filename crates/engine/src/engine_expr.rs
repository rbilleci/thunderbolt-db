...
use predicate_operands::{
    ...
    is_int4_literal, numeric_column_index, numeric_literal_value, text_column_index,
    text_literal_value, timestamp_column_index, timestamp_literal_micros, uuid_column_index,
    uuid_literal_bytes,
};
