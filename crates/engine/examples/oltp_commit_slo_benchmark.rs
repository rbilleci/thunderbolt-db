...
fn main() -> Result<(), Box<dyn Error>> {
    ...
    for &writers in &writers_sweep {
        ...
        // TYPE-COVERAGE track 2 slice 2: GPU_DB_BENCH_I64SHARDS=1 = i64 sections in sharded
        // admission (pair with GPU_DB_BENCH_INT8=1 + GPU_DB_BENCH_ELIDE=1 for the full arc).
        if std::env::var("GPU_DB_BENCH_I64SHARDS").is_ok_and(|v| v == "1") {
