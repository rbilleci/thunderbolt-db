...
use gpu_db_protocol::{parse_command, parse_copy_from_stdin, Command};
...
fn main() -> Result<(), Box<dyn Error>> {
    ...
    println!("next_blocker=engine_copy_to_wal_mvcc_adapter_required");
    println!("secondary_blocker=session_catalog_trait_required");
