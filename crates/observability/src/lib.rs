    ...
    fn residency_status_helpers_summarize_tables_and_budgets() {
        let status = RelationalResidencyStatus {
            ...
            latest_route_decisions: vec![RelationalResidentRouteDecisionStatus {
                ...
                last_execution_wall_micros: Some(100),
                last_execution_device_lookup_micros: Some(10),
                last_execution_match_index_micros: Some(20),
                last_execution_selected_projection_micros: Some(30),
                last_execution_result_materialization_micros: Some(40),
                last_execution_matched_rows: Some(1),
            }],
