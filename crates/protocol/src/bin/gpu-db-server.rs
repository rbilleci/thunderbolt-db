...
mod ddl_syntax;
use ddl_syntax::{
    parse_alter_table_drop_constraint, parse_drop_table, parse_truncate_table,
    unsupported_foreign_key_option_query,
};
#[cfg(test)]
use ddl_syntax::{DropConstraint, DropTable, ParsedTruncateTable};
