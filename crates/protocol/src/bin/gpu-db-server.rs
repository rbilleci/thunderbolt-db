...
mod pg_dump_compat;
#[cfg(test)]
use pg_dump_compat::pg_dump_empty_catalog_query_columns;
use pg_dump_compat::{
    is_pg_dump_domain_constraints_execute, is_pg_dump_domain_constraints_prepare,
    is_pg_dump_domain_dump_prepare, is_pg_dump_function_dump_prepare,
    ...
    pg_dump_function_dump_rows, try_execute_pg_dump_compat_statement,
};
