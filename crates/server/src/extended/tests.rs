...
fn bind_codec_errors_use_postgresql_semantic_sqlstates() {
    ...
    for (portal, statement, formats, values, expected) in vec![
        ...
        (
            "trailing_timestamp_separator",
            "timestamp_arg",
            vec![0],
            vec![Some(b"2024-01-01T".to_vec())],
            "22007",
        ),
        (
            "date_field_overflow_text",
            "date_arg",
            vec![0],
            vec![Some(b"2024-02-30".to_vec())],
            "22008",
        ),
        (
            "timestamp_field_overflow_text",
            "timestamp_arg",
            vec![0],
            vec![Some(b"294277-12-31 00:00:00".to_vec())],
            "22008",
        ),
        (
            "bad_uuid_text",
        ...
        (
            "date_binary_infinity",
            "date_arg",
            vec![1],
            vec![Some(i32::MAX.to_be_bytes().to_vec())],
            "22008",
        ),
        (
            "timestamp_binary_upper_exclusive",
            "timestamp_arg",
            vec![1],
            vec![Some(9_223_371_331_200_000_000_i64.to_be_bytes().to_vec())],
            "22008",
        ),
        (
            "bad_uuid_binary",
