# ARCHIVED — Lane UPDATE/DELETE intent design

> Superseded implementation design. Lane UPDATE and DELETE subsequently shipped; this document's remaining
> decisions and sequencing are historical, not actionable.
