# ARCHIVED — Write Conveyor research record

> Historical benchmark and implementation journal. It is not an executable plan. Current durability and
> write-path work is tracked only in `docs/PLAN.md`.
