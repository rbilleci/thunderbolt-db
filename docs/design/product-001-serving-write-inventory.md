...
published sequence remain distinct from this transactional lifecycle/reset boundary; their live implementation
state and next acceptance boundary are recorded only by **PRODUCT-001** in PLAN.
