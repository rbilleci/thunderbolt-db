...
This is a factual inventory captured and updated on 2026-07-24 for the PRODUCT-001 consolidation. It does not
...
remains fail-closed under PRODUCT-001. An intervening DML/KV commit no longer forces a retry when every catalog field plus
the OID/column-ID allocator high-waters remains unchanged: READ COMMITTED rebinds the private overlay and GPU delta
