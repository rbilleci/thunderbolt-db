...
1. **STRUCT-001AV — map and sequence the legacy statement dispatcher.** Audit `execute_statement` branch
   families, state/catalog dependencies, tests, and co-change history; promote concrete extraction children at
   the top of this ledger before editing the dispatcher. Do not create arbitrary branch-range shards.
