...
12. Treat physical page-image base backups, durable object-storage backup, timeline branching, and automatic background cleanup as not yet implemented.
