...
15. Treat physical page-image base backups, production object-storage APIs, production timeline failover/GC orchestration, and live background cleanup scheduling as not yet implemented.
