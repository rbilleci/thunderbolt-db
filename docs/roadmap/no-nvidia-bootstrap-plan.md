...
- Next obvious extension boundary: widen the same-subpath first/last-occurrence surface from exact offsets into inclusive offset-range helpers without weakening the explicit fallback contract.
