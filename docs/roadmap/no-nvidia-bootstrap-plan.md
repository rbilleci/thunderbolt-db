...
- Next obvious extension boundary: extend the frame-bundle surface toward first/last-occurrence constraints without weakening the explicit fallback contract.
