...
- Next obvious extension boundary: widen the new mixed-subpath relative-occurrence surface from exact distances into inclusive distance-range helpers without weakening the explicit fallback contract.
