...
- Next obvious extension boundary: extend the new frame-bundle surface beyond the current key/value exact-membership and path-summary controls into richer positional or quantified bundle predicates without weakening the explicit fallback contract.
