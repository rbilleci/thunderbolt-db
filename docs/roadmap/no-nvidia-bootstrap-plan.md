...
- Next obvious extension boundary: extend the frame-bundle surface beyond the new counted membership thresholds into richer quantified or positional predicates without weakening the explicit fallback contract.
