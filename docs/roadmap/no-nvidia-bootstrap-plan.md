...
- Next obvious extension boundary: widen the mixed-subpath ordinal-occurrence surface from exact/ranged nth-offset helpers into first/last mixed-occurrence offset helpers without weakening the explicit fallback contract.
