...
- Next obvious extension boundary: widen the provenance bundle offset surface from same-subpath occurrence offsets into reusable mixed-subpath or distance-oriented projection/order helpers without weakening the explicit fallback contract.
