...
- Next obvious extension boundary: widen the same-subpath offset surface from single explicit ordinal pins into exact/ranged ordinal-pair offset helpers without weakening the explicit fallback contract.
