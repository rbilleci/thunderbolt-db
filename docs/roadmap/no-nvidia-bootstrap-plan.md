...
- Next obvious extension boundary: extend the frame-bundle surface from exact/ranged occurrence offsets toward richer relative-occurrence constraints without weakening the explicit fallback contract.
