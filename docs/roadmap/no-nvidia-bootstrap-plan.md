...
- Next obvious extension boundary: extend the frame-bundle surface from exact/ranged occurrence distances toward mixed-subpath relative-occurrence constraints without weakening the explicit fallback contract.
