...
- Next obvious extension boundary: widen the new mixed-subpath relative-occurrence surface from inclusive distance ranges into first/last or ordinal mixed-occurrence helpers without weakening the explicit fallback contract.
