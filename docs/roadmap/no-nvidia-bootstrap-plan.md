...
- Next obvious extension boundary: widen the deeper source-preserving join-composition surface beyond the new deeper terminal/fan-out siblings (for example more composable nested join helpers) without weakening the explicit fallback contract.
