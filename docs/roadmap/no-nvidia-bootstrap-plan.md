...
- Next obvious extension boundary: widen the mixed-subpath relative-occurrence surface from first/last distance helpers into ordinal mixed-occurrence helpers without weakening the explicit fallback contract.
