...
- Next obvious extension boundary: extend the frame-bundle surface beyond first/last-occurrence offsets toward richer ordinal occurrence constraints without weakening the explicit fallback contract.
