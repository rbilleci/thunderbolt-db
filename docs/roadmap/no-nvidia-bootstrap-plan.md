...
- Next obvious extension boundary: extend the frame-bundle surface beyond exact ordinal occurrence offsets toward richer occurrence-range or relative-occurrence constraints without weakening the explicit fallback contract.
