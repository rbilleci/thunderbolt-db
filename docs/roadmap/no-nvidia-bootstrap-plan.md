...
- Next obvious extension boundary: widen the provenance bundle offset surface from filter predicates into reusable projection/order helpers without weakening the explicit fallback contract.
