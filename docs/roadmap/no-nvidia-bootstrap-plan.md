...
- Next obvious extension boundary: widen the same-subpath first/last-occurrence surface from exact/ranged offset helpers into first/last relative-distance helpers without weakening the explicit fallback contract.
