...
- Next obvious extension boundary: widen the mixed-subpath first/last offset surface from paired first/last helpers into first/last-to-explicit-ordinal offset helpers without weakening the explicit fallback contract.
