...
- Next obvious extension boundary: widen the mixed-subpath first/last relative-distance surface from adjacent-pair helpers into first/last-to-explicit-ordinal distance helpers without weakening the explicit fallback contract.
