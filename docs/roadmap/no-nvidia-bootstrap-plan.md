...
- Next obvious extension boundary: widen the deeper source-preserving join-composition surface beyond the new four-hop prefix/terminal siblings (for example more composable nested join helpers) without weakening the explicit fallback contract.
