...
1. **STRUCT-001EA:** externalize the exact seven-test second-refresh advanced-replacement repair family behind
   the unchanged parent test facade; preserve bodies/names and do not change production code or visibility.
