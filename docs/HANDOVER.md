...
1. **STRUCT-001CF:** move the three domain catalog-read shapes and their private query/row helpers into the
   existing domain owner behind one tri-state delegate, preserving exact psql/direct metadata output.
