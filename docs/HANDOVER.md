...
1. **STRUCT-001DT:** isolate exact replication progress/status/recovery contracts and their contiguous invariant
   tests behind stable crate-root re-exports; preserve validation/errors, projection, APIs, and test names.
