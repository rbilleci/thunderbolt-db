...
- STRUCT-001LD analysis is complete. The 3,668-line server-owned example has an acyclic three-leaf disposition:
  ...
  repair first.
- STRUCT-001LE is closed. Exactly three endpoint build selectors now use the owning `gpu_db_server` package; the
...
- STRUCT-001LG is closed. The normalized-exact retained literal/exact batch contract now lives in the 126-line
