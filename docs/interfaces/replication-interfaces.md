...
- **Stale-snapshot stability:** snapshot installs that target an older frontier, or the same frontier with a conflicting term, are progress/status no-ops; they do not rewrite `snapshot_id`, frontier, or validated lag/accounting surfaces.
