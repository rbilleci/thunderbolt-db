...
- Next obvious Q2 extension is to widen the frame-bundle surface beyond exact ordinal occurrence offsets toward richer occurrence-range or relative-occurrence constraints without weakening the explicit GPU fallback contract.
