...
- Next obvious Q2 extension is to widen the mixed-subpath relative-occurrence surface from inclusive distance ranges into first/last or ordinal mixed-occurrence helpers without weakening the explicit GPU fallback contract.
