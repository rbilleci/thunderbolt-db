...
- Next obvious Q2 extension is to widen the provenance bundle offset surface from filter predicates into reusable projection/order helpers without weakening the explicit GPU fallback contract.
