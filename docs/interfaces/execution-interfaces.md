...
- Next obvious Q2 extension is to widen the reusable provenance projection/order surface from pair-oriented mixed-subpath offset views into reusable pair-oriented mixed-subpath distance views without weakening the explicit GPU fallback contract.
