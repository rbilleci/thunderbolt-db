...
- Next obvious Q2 extension is widening the explicit source-composition surface beyond ordered concatenation/deduplication (for example intersection semantics or deeper nested join-composition helpers) without weakening the explicit GPU fallback contract.
