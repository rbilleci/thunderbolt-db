...
- Next obvious Q2 extension is to widen the mixed-subpath ordinal-occurrence surface from exact/ranged nth-offset helpers into first/last mixed-occurrence offset helpers without weakening the explicit GPU fallback contract.
