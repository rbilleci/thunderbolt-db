...
| `2026-06-02-p8-retained-read-snapshot-fast-path-v1` | `2026-06-02-p8-retained-read-snapshot-fast-path-v1-assets/` | opt-in encoded retained read response cache demonstrator; completed 3090 artifact packaged without rerun |
