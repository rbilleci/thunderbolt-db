...
- graph_assets: docs/testing/reports/series/p8-retained-concurrency/assets/2026-06-02-p8-retained-read-snapshot-fast-path-v1-assets/
...
`series/p8-retained-concurrency/assets/2026-06-02-p8-retained-read-snapshot-fast-path-v1-assets/steady-state-response-optimization-metrics.csv`.

![Throughput history](../../../series/p8-retained-concurrency/assets/2026-06-02-p8-retained-read-snapshot-fast-path-v1-assets/throughput-history.svg)

![P50 latency history](../../../series/p8-retained-concurrency/assets/2026-06-02-p8-retained-read-snapshot-fast-path-v1-assets/p50-latency-history.svg)

![COUNT phase breakdown](../../../series/p8-retained-concurrency/assets/2026-06-02-p8-retained-read-snapshot-fast-path-v1-assets/count-phase-breakdown.svg)

![Lookup phase breakdown](../../../series/p8-retained-concurrency/assets/2026-06-02-p8-retained-read-snapshot-fast-path-v1-assets/lookup-phase-breakdown.svg)
