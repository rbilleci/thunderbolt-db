...
- unsupported_production_cache_claims: broad workload-level GPU advantage, normal planner routing to retained handles, production cache manager, allocator/eviction policy beyond deterministic budget admission evidence
