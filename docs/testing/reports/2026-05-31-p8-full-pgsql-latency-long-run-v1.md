...
`docs/testing/reports/2026-05-31-p8-post-cleanup-25pct-side-by-side-v1.md`.
...
| GPU DB full-tier report | `docs/testing/reports/2026-05-31-p8-post-cleanup-25pct-side-by-side-v1.md` |
...
| order_line_count_all | 161,061,274 / 25% | GPU DB | 623 | 623 | 623 | 1592.737 | ~0.0006s | pass | 0 | 0 | 16 us | `docs/testing/reports/2026-05-31-p8-post-cleanup-25pct-side-by-side-v1.md` | 8325.788x |
...
| order_line_sum_amount | 161,061,274 / 25% | GPU DB | 6,637,078 | 6,637,078 | 6,637,078 | 0.151 | ~6.62s | pass | 0 | 0 | 6,636,618 us | `docs/testing/reports/2026-05-31-p8-post-cleanup-25pct-side-by-side-v1.md` | 0.809x |
...
| order_line_avg_quantity_between | 161,061,274 / 25% | GPU DB | 18,214,923 | 18,214,923 | 18,214,923 | 0.055 | ~18.18s | pass | 0 | 528,280,972 | 12,677,452 us | `docs/testing/reports/2026-05-31-p8-post-cleanup-25pct-side-by-side-v1.md` | 0.262x |
...
| order_line_max_amount_filter | 161,061,274 / 25% | GPU DB | 11,828,569 | 11,828,569 | 11,828,569 | 0.085 | ~11.76s | pass | 0 | 8 | 11,826,938 us | `docs/testing/reports/2026-05-31-p8-post-cleanup-25pct-side-by-side-v1.md` | 0.224x |
