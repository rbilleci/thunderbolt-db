...
| `aws-lc-rs 1.18.1`, `aws-lc-sys 0.45.0` | TLS cryptography implementation fetched and built by Cargo | ISC/Apache-2.0 and the additional permissive terms reproduced in `THIRD_PARTY_LICENSES/AWS-LC.txt`. |
