...
- CUDA hardware onboarding has a driver-level launch smoke path in `CudaDriverRuntime::launch_smoke_add_one(...)`, covering PTX module load, device allocation, kernel launch, synchronization, and D2H copy before MVCC kernels are ported.
