...
- `FLUSH`, `FLUSH WAL`, `FLUSH LOG`, `FLUSH WRITE AHEAD LOG`, and `FLUSH WRITE-AHEAD LOG` are equivalent admin/coordination commands and are tracked as CPU fallback metric events.
