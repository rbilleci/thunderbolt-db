...
- Next obvious extension boundary:
  - widen the mixed-subpath ordinal-occurrence surface from exact/ranged nth-offset helpers into first/last mixed-occurrence offset helpers without regressing the same engine-facing contract and explicit fallback accounting on the eventual GPU-backed path.
