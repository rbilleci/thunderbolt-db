...
- Next obvious extension boundary:
  - widen the mixed-subpath relative-occurrence surface from first/last distance helpers into ordinal mixed-occurrence helpers without regressing the same engine-facing contract and explicit fallback accounting on the eventual GPU-backed path.
