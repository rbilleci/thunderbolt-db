...
require_line crates/server/src/cancellation.rs "ConstantTimeEq"
require_line crates/server/src/cancellation.rs "connection attempted overlapping frontend requests"
require_line crates/server/src/cancellation.rs "cancel_effect_free_success"
require_line crates/server/src/wire_response.rs "writer.backend_key_data"
require_line crates/server/src/wire_response.rs "Any error may represent an indeterminate post-durable failure"
require_line crates/server/src/wire_response.rs "command/RETURNING result may already be published"
require_line crates/server/src/security.rs "is_malformed_cancel_request"
require_line crates/server/src/async_submit.rs "analyze_prepare_cancellable"
require_line crates/server/src/async_submit.rs "complete_simple_query_action"
require_line crates/server/src/async_submit.rs "batched_fallback_rechecks_cancellation_after_the_session_lock"
require_line crates/server/src/tests.rs "async_cancelled_queued_extended_sync_rolls_back_staged_insert"
require_line crates/server/src/cancellation.rs "queued_simple_query_implicit_commit_cancels_to_rollback_without_publication"
require_line crates/server/src/copy.rs "finish_copy_from_guarded"
require_line crates/server/src/copy.rs ".acquire_permit(executor)"
require_line crates/server/src/transport.rs "MAX_AUTH_FRAME_BYTES: usize = 64 * 1024"
require_line crates/server/src/transport.rs "prevents a partial"
require_line crates/server/src/transport.rs "simultaneously ready complete COPY frame lost to cancellation"
require_line crates/server/src/lib.rs "drain_cancelled_simple_copy_frame"
