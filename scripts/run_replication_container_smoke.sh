...
network="gpu-db-replication-smoke-$$"
container_a="gpu-db-replication-smoke-a-$$"
container_b="gpu-db-replication-smoke-b-$$"
build_context="$(mktemp -d "${TMPDIR:-/tmp}/gpu-db-replication-container-smoke.XXXXXX")"
