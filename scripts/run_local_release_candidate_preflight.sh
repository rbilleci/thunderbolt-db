...
run_gate \
  ...
  "local_product_preflight_drivers=tokio-postgres,sqlx,node-postgres,asyncpg,psycopg,pgx" \
  ...
  "local_product_preflight_gap_jdbc_r2dbc=not_configured" \
...
printf 'local_release_candidate_preflight_drivers=tokio-postgres,sqlx,node-postgres,asyncpg,psycopg,pgx\n'
