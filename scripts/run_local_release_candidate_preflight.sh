...
run_gate \
  ...
  "local_product_preflight_drivers=tokio-postgres,sqlx,node-postgres,asyncpg,psycopg,pgx,jdbc" \
  ...
  "local_product_preflight_gap_r2dbc=not_configured" \
...
run_gate \
  ...
  "connection_security_posture_preflight_scope=local_dev_trust_auth_no_tls_boundary" \
  "connection_security_posture_preflight_ssl_request=declined_N" \
  "connection_security_posture_preflight_gssenc_request=declined_N" \
  "connection_security_posture_preflight_startup_authentication=authentication_ok_trust_style" \
  "connection_security_posture_preflight_password_messages=unsupported_after_startup" \
  "connection_security_posture_preflight_sasl=unsupported" \
  "connection_security_posture_preflight_role_password_catalog=no_password_storage" \
  "connection_security_posture_preflight_production_security_profile=not_supported" \
  "connection_security_posture_preflight_gap_scram_sha_256=missing" \
  "connection_security_posture_preflight_gap_password_authentication_storage=missing" \
  "connection_security_posture_preflight_gap_tls_client_connections=missing" \
  "connection_security_posture_preflight_gap_replication_mtls=missing" \
  "connection_security_posture_preflight_gap_certificate_lifecycle=missing" \
  "connection_security_posture_preflight_gap_audit_hash_chain=missing" \
  "connection_security_posture_preflight_gap_row_level_security=missing" \
  "connection_security_posture_preflight_gap_masking=missing" \
  "connection_security_posture_preflight_trigger_full_auth_tls=named_production_security_profile_secret_storage_certificate_lifecycle_deployment_policy"
...
printf 'local_release_candidate_preflight_drivers=tokio-postgres,sqlx,node-postgres,asyncpg,psycopg,pgx,jdbc\n'
