...
run_gate \
  ...
  "application_driver_smoke_r2dbc=not_configured" \
...
printf 'local_product_preflight_drivers=tokio-postgres,sqlx,node-postgres,asyncpg,psycopg,pgx,jdbc\n'
...
printf 'local_product_preflight_gap_r2dbc=not_configured\n'
