...
run_gate \
  ...
  "application_driver_smoke_r2dbc_target=canonical_gpu_catalog" \
  "application_driver_smoke_canonical_targets=tokio-postgres,sqlx,node-postgres,asyncpg,psycopg,pgx,jdbc,r2dbc" \
...
printf 'local_product_preflight_drivers=tokio-postgres,sqlx,node-postgres,asyncpg,psycopg,pgx,jdbc,r2dbc\n'
