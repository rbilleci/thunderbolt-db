...
PSQL_GOLDEN_BOOT_CMD="${PSQL_GOLDEN_BOOT_CMD:-cargo run -p gpu_db_protocol --bin gpu-db-server -- --listen 127.0.0.1:${PGPORT:-55432}}" \
...
printf 'local_validation_preflight_scope=fmt_clippy_all_features_psql_golden_scorecard_freshness\n'
