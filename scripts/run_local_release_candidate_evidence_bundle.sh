...
required_lines=(
  ...
  "local_release_candidate_preflight_scope=validation_postgresql_product_gpu_residency_plus_connection_security"
  ...
  "local_release_candidate_preflight_connection_security=local_dev_trust_auth_no_tls_plus_production_tls_scram_profile_v1"
  "local_release_candidate_preflight_production_scram_verifier=verifier_file_plaintext_conflict_rejection"
  "local_release_candidate_preflight_p8_ch_benchmark=checked_harness_self_check_and_baseline_report"
  "local_release_candidate_preflight_p8_ch_benchmark_report=docs/testing/reports/2026-05-30-p8-ch-benchmark-residency-baseline-v1.md"
  "local_release_candidate_preflight_replication_mtls=local_generated_ca_append_entries_smoke"
  "local_release_candidate_preflight_gap_replication_mtls=production_certificate_lifecycle_and_trust_distribution_missing"
  "local_release_candidate_preflight_gap_p8_ch_benchmark_6gib_tier=needs_streaming_generator_long_run_window_and_cleanup_budget"
  "local_release_candidate_preflight_gap_certificate_lifecycle_automation=missing"
  "local_release_candidate_preflight_gap_enterprise_identity=missing"
  "local_release_candidate_preflight_gap_kms_hsm_secret_manager=missing"
  ...
  "local_release_candidate_preflight_gap_broad_authorization=missing"
