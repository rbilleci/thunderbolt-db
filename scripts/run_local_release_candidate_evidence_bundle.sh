...
required_lines=(
  ...
  "local_release_candidate_preflight_connection_security=local_dev_trust_auth_no_tls_boundary"
  "local_release_candidate_preflight_gap_scram_sha_256=missing"
  "local_release_candidate_preflight_gap_password_authentication_storage=missing"
  "local_release_candidate_preflight_gap_tls_client_connections=missing"
  "local_release_candidate_preflight_gap_replication_mtls=missing"
  "local_release_candidate_preflight_gap_certificate_lifecycle=missing"
